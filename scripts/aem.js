...
async function loadMasthead(main) {
  const section = document.createElement("div");
  const mastheadBlock = buildBlock("masthead", "");
  section.append(mastheadBlock);
  main.prepend(section);
  decorateBlock(mastheadBlock);
  return loadBlock(mastheadBlock);
}
